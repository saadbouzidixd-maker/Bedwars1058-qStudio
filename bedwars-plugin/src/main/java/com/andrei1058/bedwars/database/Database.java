...
public interface Database {
    ...
    /**
     * Persist the qStudio quest progress of a player.
     *
     * @param questData      serialized progress map.
     * @param questCompleted serialized completion stamps map.
     */
    void saveQuestData(UUID uuid, String questData, String questCompleted);

    /** @return serialized quest progress, empty when absent. */
    String getQuestProgress(UUID uuid);

    /** @return serialized quest completion stamps, empty when absent. */
    String getQuestCompletions(UUID uuid);

    /** Persist the unlocked qStudio achievements of a player. */
    void saveAchievements(UUID uuid, String serialized);

    /** @return serialized unlocked achievements, empty when absent. */
    String getAchievements(UUID uuid);
}
